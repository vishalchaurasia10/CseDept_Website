...
const Industry = () => {
    return (
        <>
            <div className="industryPartners overflow-hidden px-4 mb-16 lg:mb-24 lg:px-40 my-10">
                ...
                <div className="slider flex space-x-10 items-center justify-center animate-scrollingMobile lg:animate-scrolling">
                    <Image
                        className='w-48'
